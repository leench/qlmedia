...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaBase.if_upload'
        db.add_column(u'transcode_mediabase', 'if_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaBase.if_upload'
        db.delete_column(u'transcode_mediabase', 'if_upload')
    ...
    models = {
        ...
        u'transcode.mediabase': {
            ...
            'if_upload': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
