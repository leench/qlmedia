...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'transcode_video', u'id')

        # Adding field 'Video.mediabase_ptr'
        db.add_column(u'transcode_video', u'mediabase_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['transcode.MediaBase'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Video.id'
        db.add_column(u'transcode_video', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='', primary_key=True),
                      keep_default=False)

        # Deleting field 'Video.mediabase_ptr'
        db.delete_column(u'transcode_video', u'mediabase_ptr_id')
