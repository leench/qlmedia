...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaBase.output_file'
        db.add_column(u'transcode_mediabase', 'output_file',
                      self.gf('transcode.models.OutputFileField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaBase.output_file'
        db.delete_column(u'transcode_mediabase', 'output_file')
