...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaBase.publish_status'
        db.alter_column(u'transcode_mediabase', 'publish_status', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'MediaBase.publish_status'
        db.alter_column(u'transcode_mediabase', 'publish_status', self.gf('django.db.models.fields.SmallIntegerField')())
