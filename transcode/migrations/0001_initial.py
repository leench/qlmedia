...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'transcode_mediabase', (
            ...
            ('encode_status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('upload_status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('publish_status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'transcode', ['MediaBase'])

        # Adding model 'Video'
        db.create_table(u'transcode_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'transcode', ['Video'])


    def backwards(self, orm):
        # Deleting model 'MediaBase'
        db.delete_table(u'transcode_mediabase')

        # Deleting model 'Video'
        db.delete_table(u'transcode_video')
    ...
    models = {
        ...
        u'transcode.mediabase': {
            ...
            'publish_status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'upload_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'upload_status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
