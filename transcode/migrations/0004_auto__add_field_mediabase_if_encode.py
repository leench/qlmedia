...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaBase.if_encode'
        db.add_column(u'transcode_mediabase', 'if_encode',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaBase.if_encode'
        db.delete_column(u'transcode_mediabase', 'if_encode')
