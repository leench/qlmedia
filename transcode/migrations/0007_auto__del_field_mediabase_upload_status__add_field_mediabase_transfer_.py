...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaBase.upload_status'
        db.delete_column(u'transcode_mediabase', 'upload_status')

        # Adding field 'MediaBase.transfer_status'
        db.add_column(u'transcode_mediabase', 'transfer_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MediaBase.upload_status'
        db.add_column(u'transcode_mediabase', 'upload_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'MediaBase.transfer_status'
        db.delete_column(u'transcode_mediabase', 'transfer_status')
    ...
    models = {
        ...
        u'transcode.mediabase': {
            ...
            'transfer_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
